...
export type IntentionsQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type IntentionsQuery = {
  metaobjects: {
    nodes: Array<
...
export type FeaturedCollectionWithProductsQuery = {
...
export type HomepageSlidesQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id' | 'handle'> & {
        fields: Array<
...
export type RecommendationsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  collectionsFirst: StorefrontAPI.Scalars['Int']['input'];
...
export type SidebarProductsQueryVariables = StorefrontAPI.Exact<{
...
export type SidebarProductsQuery = {
  collection?: StorefrontAPI.Maybe<{
    products: {
      nodes: Array<
        Pick<StorefrontAPI.Product, 'id' | 'handle' | 'title'> & {
      ...
      Pick<StorefrontAPI.Blog, 'title' | 'handle'> & {
        articles: {
          nodes: Array<
            ...
            > & {excerpt: StorefrontAPI.Article['excerptHtml']} & {
              image?: StorefrontAPI.Maybe<
                Pick<
                  StorefrontAPI.Image,
                  'id' | 'altText' | 'url' | 'width' | 'height'
...
export type CollectionBlogPostsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type CollectionBlogPostsQuery = {
  blogs: {
    nodes: Array<
      Pick<StorefrontAPI.Blog, 'handle'> & {
        articles: {
...
export type CollectionItemFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'handle' | 'title' | 'tags' | 'createdAt'
> & {
  featuredImage?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Image, 'id' | 'altText' | 'url' | 'width' | 'height'>
  >;
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query Intentions {\n    metaobjects(type: "intention", first: 20) {\n      nodes {\n        id\n        handle\n        fields {\n          key\n          value\n          reference {\n            ... on Collection {\n              id\n              handle\n              title\n            }\n            ... on MediaImage {\n              image { url altText width height }\n            }\n            ... on GenericFile {\n              id\n              url\n              mimeType\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: IntentionsQuery;
    variables: IntentionsQueryVariables;
  };
  ...
  '#graphql\n  query SidebarProducts(\n    $handle: String!\n    $first: Int!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      products(first: $first, sortKey: BEST_SELLING) {\n        nodes {\n          id\n          handle\n          title\n          featuredImage {\n            id\n            altText\n            url\n            width\n            height\n          }\n          priceRange {\n            minVariantPrice {\n              amount\n              currencyCode\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: SidebarProductsQuery;
    variables: SidebarProductsQueryVariables;
  };
  ...
  '#graphql\n  query CollectionBlogPosts($country: CountryCode, $language: LanguageCode)\n  @inContext(country: $country, language: $language) {\n    blogs(first: 8) {\n      nodes {\n        handle\n        articles(first: 8, sortKey: PUBLISHED_AT, reverse: true) {\n          nodes {\n            id\n            title\n            handle\n            publishedAt\n            excerpt: excerptHtml\n            image {\n              id\n              altText\n              url\n              width\n              height\n            }\n            blog {\n              handle\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: CollectionBlogPostsQuery;
    variables: CollectionBlogPostsQueryVariables;
  };
