    ...
    return (
        <div className="flex flex-col gap-3">
            <div className="relative aspect-[4/3] rounded-xl overflow-hidden bg-muted border border-border flex items-center justify-center">
                ...
                <button
                    onClick={prev}
                    className="absolute left-2 top-1/2 -translate-y-1/2 w-7 h-7 bg-background/80 border border-border rounded-full flex items-center justify-center hover:bg-background transition-colors"
                >
                    <svg className="w-3.5 h-3.5 text-foreground" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" /></svg>
                </button>
                <button
                    onClick={next}
                    className="absolute right-2 top-1/2 -translate-y-1/2 w-7 h-7 bg-background/80 border border-border rounded-full flex items-center justify-center hover:bg-background transition-colors"
                >
                    <svg className="w-3.5 h-3.5 text-foreground" fill="none" stroke="currentColor" strokeWidth={2.5} viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" /></svg>
                </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
                    ...
                    <div className="bg-card border border-border rounded-2xl p-6 shadow-sm flex flex-col gap-5">
                        ...
                        <div className="rounded-xl bg-muted/40 border border-border/50 p-4 flex flex-col gap-3">
                            <div>
                                <p className="text-xs font-semibold text-foreground">Have questions about authenticity?</p>
                                <p className="text-[11px] text-muted-foreground mt-0.5">Our experts are just a call away — we will walk you through every certificate.</p>
                            </div>
                            <div className="flex flex-col xs:flex-row gap-2">
                                <a
                                    href="tel:+919876543210"
                                    className="group inline-flex items-center justify-center gap-2 bg-foreground text-background rounded-full px-4 py-2.5 text-xs font-semibold hover:opacity-90 transition-opacity"
                                >
                                ...
                                <a
                                    ...
                                    className="group inline-flex items-center justify-center gap-2 bg-[#25D366] text-white rounded-full px-4 py-2.5 text-xs font-semibold hover:opacity-90 transition-opacity"
                                >
