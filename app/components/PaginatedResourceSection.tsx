        ...
        return (
          <div className="flex flex-col">
            <div className="flex justify-center py-4">
              <PreviousLink className="inline-flex items-center gap-2 px-6 py-2.5 bg-stone-900 text-white text-xs font-semibold tracking-[0.15em] uppercase rounded-full shadow-md hover:bg-stone-800 hover:shadow-lg transition-all duration-300 cursor-pointer">
                {isLoading ? (
            ...
            <div className="flex justify-center pt-10 pb-4">
              <NextLink className="group inline-flex items-center gap-2 px-8 py-3 bg-stone-900 text-white text-xs font-semibold tracking-[0.15em] uppercase rounded-full shadow-md hover:bg-stone-800 hover:shadow-lg hover:scale-[1.03] transition-all duration-300 cursor-pointer">
                {isLoading ? (
                  <span className="inline-flex items-center gap-2">
                    <svg className="w-4 h-4 animate-spin" viewBox="0 0 24 24" fill="none"><circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="3" /><path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z" /></svg>
                    Loading…
