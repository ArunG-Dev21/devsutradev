...
function CartSelectionHeader({
  ...
  return (
    <div className={`flex items-center gap-3 sm:gap-4 ${layout === 'aside' ? 'pb-3 mb-2 pt-3 border-b border-border' : 'pb-4 mb-4 pt-1 border-b border-border'}`}>
      ...
      >
        <div className={`w-5 h-5 rounded-full flex items-center justify-center transition-colors border shadow-sm ${isAllSelected ? 'bg-[#F14514] border-[#F14514] text-white' : 'bg-white border-gray-300'}`}>
          {isAllSelected && (
