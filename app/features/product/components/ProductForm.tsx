      ...
      <div className="flex gap-1 md:gap-3 pt-2">
        <div className="flex-1 w-full flex [&>form]:w-full">
          <AddToCartButton
            ...
            productImage={productImage || selectedVariant?.image || undefined}
            lines={
              selectedVariant
                ? [
                  {
            ...
            {selectedVariant?.availableForSale ? (
              <>
                <img
                  ...
                  alt=""
                  className="w-4 h-4 md:w-5 md:h-5 shrink-0 dark:invert dark:brightness-0 group-hover:invert transition-all"
                />
                Add to Bag
              </>
            ) : (
