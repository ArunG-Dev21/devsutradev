                                    ...
                                    activeTab.products.map((product) => {
                                        ...
                                        return (
                                            <Link
                                                ...
                                                className="group flex-none w-[46%] sm:w-[42%] md:w-[31%] snap-start relative rounded-2xl overflow-hidden bg-neutral-900 aspect-square transition-shadow duration-500"
                                            >
                                                {/* Product Image */}
