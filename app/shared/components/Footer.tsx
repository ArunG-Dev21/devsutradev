          ...
          <footer className="border-t border-primary-border dark:border-border text-text-main dark:text-foreground w-full bg-background">
            <div className="container mx-auto px-3 sm:px-10 lg:px-16 pt-10 pb-10">
              ...
              <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-16 mb-16">
                ...
                {/* LEFT — Branding & About */}
                <div className="w-full lg:w-[40%] flex flex-col items-center text-center lg:items-start lg:text-left mb-10 lg:mb-0">
                  ...
                  <p className="text-text-muted text-[13px] leading-relaxed max-w-sm mx-auto lg:mx-0 mb-8 lg:mb-10">
                    ...
                    <div className="flex flex-col items-center lg:items-start">
                      ...
                      <ul className="space-y-3">
                        {[
                          ...
                          <li key={link.title} className="flex justify-center lg:justify-start w-full">
                            <NavLink
                              to={link.url}
                              prefetch="intent"
                      ...
                      <ul className="space-y-3">
                        {footer?.menu
                          ? footer.menu.items.map((item) => {
                            ...
                            return (
                              <li key={item.id} className="flex justify-center lg:justify-start w-full">
                                <NavLink
                                  to={url}
                                  prefetch="intent"
                                  className="text-text-muted hover:text-text-main text-[13px] transition-colors duration-300 relative group flex items-center w-fit"
              ...
              {/* ───────────── Bottom Bar ───────────── */}
              <div className="border-t border-primary-border pt-8 flex flex-col md:flex-row items-center justify-between text-center gap-4 text-[13px] text-text-muted">
                <div>
                  © {new Date().getFullYear()} {header.shop.name || SITE_NAME} All rights reserved
                </div>

                <div className="flex justify-center gap-6">
                  <span className="flex items-center gap-1.5">
                    Made with <span className="text-[#F14514] text-[15px] leading-none">♥</span> in India
                  </span>
                </div>
              </div>
