export function StarRating({
  ...
  return (
    ...
    >
      ...
      <span className="text-xs font-medium leading-none tabular-nums font-montserrat">
        {rating.toFixed(1)}
      </span>
      {typeof count === 'number' && (
        <span className="text-xs font-normal leading-none opacity-80 tabular-nums font-montserrat">
          | ({count})
        </span>
      )}
    </div>
