  ...
  return (
    <div>
      ...
      <div className="mb-8 pb-6 border-b border-border">
        <Link
          to="/account/orders"
          className="inline-flex items-center gap-1.5 text-[11px] font-semibold text-muted-foreground hover:text-foreground transition-colors mb-5 uppercase tracking-widest"
        >
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
          ...
          <a
            ...
            className="shrink-0 inline-flex items-center gap-2 px-5 py-2.5 bg-foreground text-background text-[11px] font-semibold tracking-widest uppercase rounded-full hover:opacity-85 transition-opacity"
          >
            Track Shipment
