      ...
      <div className="relative bg-stone-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 text-center">
          ...
          <div className="flex items-center justify-center gap-2 mt-5 text-xs text-stone-500">
            ...
            <a href="/collections/all" className="hover:text-amber-400 transition-colors">Collections</a>
            <span className="text-stone-700">›</span>
            <span className="text-amber-400">{collection.title}</span>
          </div>
        </div>
      </div>
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between mb-5 gap-4 flex-wrap">
              <div className="flex items-center gap-3">
                ...
                <p className="text-xs text-stone-500 tracking-wide">
                  Browsing <span className="font-medium text-stone-700">{collection.title}</span>
                </p>
              </div>
            ...
            {!collection.products?.nodes?.length && (
              <div className="text-center py-24">
                ...
                <p className="text-sm text-stone-400 mb-6">Check back soon or explore other collections.</p>
                <a
