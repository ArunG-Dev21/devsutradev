          ...
          <SearchForm>
            {({ inputRef }) => (
              <div className="relative flex items-center transition-shadow duration-300 rounded-full">
                ...
                />
                <button type="submit" aria-label="Search" className="absolute right-2 p-3 bg-[#F14514] text-white rounded-full transition-colors flex items-center justify-center cursor-pointer hover:bg-[#F14514] hover:scale-105 active:scale-95" >
                  <svg
